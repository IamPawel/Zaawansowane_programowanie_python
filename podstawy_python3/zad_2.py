...
class Employee:
    ...
    def __str__(self):
        return (
            ...
            f"hired: {self.hire_date}, born: {self.birth_date}, \n"
            f"address: {self.city}, st.{self.street}, zip code:{self.zip_code}, \n"
            f"tel:{self.phone}"
        )
...
class Book:
    ...
    def __str__(self):
        return (
            ...
            f"in: {self.library} st.{self.library.street} "
            f"{self.library.city} {self.library.zip_code} "
            f"\ntel:{self.library.phone}"
        )
...
biblioteka1 = Library(
    "Warszawa", "Marszałkowska", "00-001", "8:00-20:00", "123-456-789"
)
